...
import miku.entity.MazeEntityBase;
...
public class TrapBase<T extends MazeEntityBase> extends Block {
    ...
    public void onEntityWalk(@Nonnull World worldIn, @Nonnull BlockPos pos, @Nonnull Entity entityIn){
        ...
        @SuppressWarnings("unchecked") T entity = (T) new MazeEntityBase(worldIn);
